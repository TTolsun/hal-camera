...
class MainActivity : ComponentActivity() {
    ...
    private fun buildUi() {
        ...
        cases.addView(button("CTS 케이스 실행") { startActivity(Intent(this,dev.halcamera.compat.CtsCaseActivity::class.java)) }.apply { contentDescription="CTS RecordingTest#testBasicRecording을 앱 안에서 실행" },LinearLayout.LayoutParams(0,dp(48),1f))
