...
class HealthMonitor(
    ...
    fun assess(events: List<Event>, session: String, now: Long): Assessment {
        ...
        val threeA = "AE ${dev.halcamera.telemetry.stateName("AE", last.ae)} · AF ${dev.halcamera.telemetry.stateName("AF", last.af)} · AWB ${dev.halcamera.telemetry.stateName("AWB", last.awb)}"
