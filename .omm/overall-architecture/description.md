...
Home·Auto Check·건강 판정 코드는 M3에서 제거되었습니다. 이 관점의 diagnosis와 check-runner 하위 항목, persistence의 health-report·baseline-store, screens의 home-screen·check-screen·run-summary는 v0.2 이력이며 현재 구현으로 해석하지 않습니다. 공통 지표 추출은 metrics/, endpoint 열거는 camera/에 있습니다.
