`app/src/main/java/dev/halcamera/benchmark/domain/RegressionRules.kt`, version `regression-rule-v1`. The only place regression thresholds live, per `PLAN-BenchMarker-v0.3.md` 7.2. `RegressionDetector` applies these rules when comparing runs.
