benchmark/domain/BenchmarkModel.kt는 BenchmarkRun, BenchmarkMetric, MeasurementContract와 실행 메타데이터를 정의합니다. comparisonContractId는 프로파일·지표 정의 버전·통계 방법·시계의 조합입니다.
