Turns the runner's raw samples into BenchmarkMetric statistics, and nothing else: no thresholds, no judgement. Comparison fields stay UNKNOWN(no_baseline) inside this evaluator; the separate RegressionDetector implementation applies comparisons.
