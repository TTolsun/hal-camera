`app/src/main/java/dev/halcamera/benchmark/domain/BenchmarkProfile.kt` (105 lines). An immutable description of *how* a run drove the camera, per `PLAN-BenchMarker-v0.3.md` chapter 3.
