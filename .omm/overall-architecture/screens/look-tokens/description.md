The only place colours, text styles and card/row builders are defined, mapping docs/design/DESIGN.md onto the two surfaces described in PRODUCT-v0.2.md 11.6.
