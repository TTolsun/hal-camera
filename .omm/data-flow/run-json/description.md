BenchmarkReport는 files/benchmarks/<runId>.json에 schema 5를 기록하고 schema 3부터 5까지 읽습니다. profile, 측정 계약, 기기·앱·subject·환경, validity, 지표와 원시 이벤트를 저장합니다. files/incidents/의 ZIP은 별도의 incident 기록입니다. 현재 앱은 v0.2 HealthReport를 작성하지 않습니다.
