...
public class Camera2SurfaceViewTestCase extends Camera2ParameterizedTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        dev.halcamera.ctsvendor.VendoredCts.attachTest(this); // halcamera: lets the host abort by closing mCamera
    ...
    public void tearDown() throws Exception {
        dev.halcamera.ctsvendor.VendoredCts.detachTest(this); // halcamera
