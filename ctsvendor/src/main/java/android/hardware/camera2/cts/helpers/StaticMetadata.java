...
public class StaticMetadata {
    ...
    // halcamera: sharedSessionConfigurationPresent() and getSharedSessionConfiguration() are removed; the
    // SHARED_SESSION_CONFIGURATION key is a @FlaggedApi that the public SDK 36 stubs do not expose.
