...
public class Camera2ParameterizedTestCase extends CameraParameterizedTestCase {
    ...
    private String[] deriveCameraIdsUnderTest() throws Exception {
        String[] idsUnderTest =
                mAdoptShellPerm && mUseAll ? mCameraManager.getCameraIdList() /* halcamera: getCameraIdListNoLazy is @TestApi */ :
    ...
    public String[] getCameraIdsUnderTest() throws Exception {
        ...
        CameraTestUtils.verifyExternalCameraConnected(mCameraManager.getCameraIdList() /* halcamera: getCameraIdListNoLazy is @TestApi */,
