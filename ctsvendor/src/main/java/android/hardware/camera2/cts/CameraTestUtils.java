...
public class CameraTestUtils extends Assert {
    ...
    private static class BlockingCameraManager
        ...
        protected class OpenListener
            ...
            OpenListener(CameraManager manager, String cameraId, boolean overrideToPortrait,
                ...
                // halcamera: openCamera(String, boolean, Handler, StateCallback) is @TestApi; the public overload is the
                // overrideToPortrait=false path. No vendored test passes true.
                if (overrideToPortrait) {
                    throw new UnsupportedOperationException("openCamera(overrideToPortrait=true) needs the test API");
                }
    ...
    public static String[] getCameraIdListForTesting(CameraManager manager,
            ...
            throws CameraAccessException {
        String [] ids = manager.getCameraIdList() /* halcamera: getCameraIdListNoLazy is @TestApi */;
