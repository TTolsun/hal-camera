...
public class CameraUtils {
    ...
    public static boolean isLegacyHAL(Context context, int cameraId) throws Exception {
        ...
        String cameraIdStr = manager.getCameraIdList() /* halcamera: getCameraIdListNoLazy is @TestApi */[cameraId];
    ...
    */
    ...
    public static boolean isDeviceFoldable(Context mContext) {
        // halcamera: the upstream body queries DeviceStateManager, which the public SDK stubs do not expose,
        // so a device that folds is reported as not foldable here.
        return false;
    }
