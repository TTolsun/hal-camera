...
세 관점의 47개 요소에 대한 근거는 [실행 계획](../../docs/PLAN-docgen-autosync.md)에 정리했습니다. 넓은 개요 요소의 근거는 관련 진입점과 계약 중심이며 모든 구현 파일을 포함하지 않습니다. 제공되지 않은 동작은 추정해서 고치지 않도록 프롬프트를 제한합니다. 원고 근거 축소와 runner 자동 실행은 후속 단계이므로 전체 무인 갱신은 아직 준비되지 않았습니다.
