...
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-22 @ `dbcb804` · Claude (drop repeat comparison) |
| 구조 원본 `state-transitions` | 최신 | 검토 2026-09-22 @ `dbcb804` · Claude (drop repeat comparison) |
| 원고 `overview` | 최신 | 검토 2026-09-22 @ `dbcb804` · Claude (drop repeat comparison) |
| 원고 `module-roles` | 최신 | 검토 2026-09-22 @ `dbcb804` · Claude (drop repeat comparison) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-22 @ `dbcb804` · Claude (drop repeat comparison) |
| 원고 `constraints` | 최신 | 검토 2026-09-22 @ `dbcb804` · Claude (drop repeat comparison) |
