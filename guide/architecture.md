...
| 구조 원본 `overall-architecture` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-26 @ `5db1846` · Codex |
...
| 구조 원본 `ui-tool-handoff` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-26 @ `5db1846` · Codex |
| 구조 원본 `ui-zoom` | 최신 | 검토 2026-09-25 @ `fffbc89` · K.H. Kim |
| 원고 `overview` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-26 @ `5db1846` · Codex |
| 원고 `module-roles` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-26 @ `5db1846` · Codex |
| 원고 `runtime-flow` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-26 @ `5db1846` · Codex |
| 원고 `constraints` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-26 @ `5db1846` · Codex |
