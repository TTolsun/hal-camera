...
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-26 @ `b5e4f3a` · Claude (retention dialog wording, code-checked) |
...
| 원고 `overview` | 최신 | 검토 2026-09-26 @ `b5e4f3a` · Claude (retention dialog wording, code-checked) |
| 원고 `module-roles` | 최신 | 검토 2026-09-26 @ `b5e4f3a` · Claude (retention dialog wording, code-checked) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-26 @ `b5e4f3a` · Claude (retention dialog wording, code-checked) |
| 원고 `constraints` | 최신 | 검토 2026-09-26 @ `b5e4f3a` · Claude (retention dialog wording, code-checked) |
