...
| 항목 | 최신성 | 검토 |
| --- | --- | --- |
| 구조 원본 `data-flow` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
| 구조 원본 `state-transitions` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
| 원고 `overview` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
| 원고 `module-roles` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
| 원고 `constraints` | 최신 | 검토 2026-09-17 @ `b67c309` · Claude |
