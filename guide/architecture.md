...
- 근거 수준: 코드 확인
- 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked)
...
| 항목 | 최신성 | 검토 |
| --- | --- | --- |
| 구조 원본 `data-flow` | 최신 | 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked) |
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked) |
...
| 원고 `overview` | 최신 | 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked) |
| 원고 `module-roles` | 최신 | 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked) |
| 원고 `constraints` | 최신 | 검토 2026-09-26 @ `46c411b` · Claude (timeout reference wording, device-checked) |
