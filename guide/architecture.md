...
| 항목 | 최신성 | 검토 |
| --- | --- | --- |
| 구조 원본 `data-flow` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
| 구조 원본 `overall-architecture` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
| 구조 원본 `state-transitions` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
| 원고 `overview` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
| 원고 `module-roles` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
| 원고 `runtime-flow` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
| 원고 `constraints` | 관련 소스 변경됨: 재검토 필요 | 검토 2026-09-19 @ `d6f5b9c` · Codex (user-delegated code review) |
