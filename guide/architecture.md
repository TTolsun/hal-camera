...
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-15 @ `7a016a8` · Claude Opus 5 (release 0.8.0) |
| 구조 원본 `state-transitions` | 최신 | 검토 2026-09-15 @ `7a016a8` · Claude Opus 5 (release 0.8.0) |
| 원고 `overview` | 최신 | 검토 2026-09-15 @ `7a016a8` · Claude Opus 5 (release 0.8.0) |
| 원고 `module-roles` | 최신 | 검토 2026-09-15 @ `7a016a8` · Claude Opus 5 (release 0.8.0) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-15 @ `7a016a8` · Claude Opus 5 (release 0.8.0) |
| 원고 `constraints` | 최신 | 검토 2026-09-15 @ `7a016a8` · Claude Opus 5 (release 0.8.0) |
