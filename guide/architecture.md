...
- 근거 수준: 코드 확인
- 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels)
...
| `camera/` | 엔진 계약, Camera2·CameraX 구현, 엔드포인트 열거를 제공합니다. `close(done)` 완료 전에 다음 카메라를 열지 않습니다. 카메라를 화면에 적는 이름(`Camera · 0 (Wide · Rear)`)도 이 패키지의 `CameraLabel` 하나가 만들며, Live·Benchmark·Probe·CTS가 모두 그것을 부릅니다. |
...
- 검증 기준 앱 버전: 0.12.0 (versionCode 114)

| 항목 | 최신성 | 검토 |
| --- | --- | --- |
| 구조 원본 `data-flow` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
| 구조 원본 `state-transitions` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
| 원고 `overview` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
| 원고 `module-roles` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
| 원고 `constraints` | 최신 | 검토 2026-09-22 @ `7f6c67c` · Claude (tool order, camera labels) |
