...
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-26 @ `e7732f0` · Claude (sub-ms delta unit, device-checked) |
...
| 원고 `overview` | 최신 | 검토 2026-09-26 @ `e7732f0` · Claude (sub-ms delta unit, device-checked) |
| 원고 `module-roles` | 최신 | 검토 2026-09-26 @ `e7732f0` · Claude (sub-ms delta unit, device-checked) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-26 @ `e7732f0` · Claude (sub-ms delta unit, device-checked) |
| 원고 `constraints` | 최신 | 검토 2026-09-26 @ `e7732f0` · Claude (sub-ms delta unit, device-checked) |
