...
- 근거 수준: 코드 확인
- 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review)
...
| 항목 | 최신성 | 검토 |
| --- | --- | --- |
| 구조 원본 `data-flow` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
| 구조 원본 `overall-architecture` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
| 구조 원본 `state-transitions` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
| 원고 `overview` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
| 원고 `module-roles` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
| 원고 `runtime-flow` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
| 원고 `constraints` | 최신 | 검토 2026-09-22 @ `e407276` · Claude (user-delegated CLI fix review) |
