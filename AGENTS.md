...
To drive the app from a terminal, follow `skills/halcam-cli/SKILL.md` (setup, commands, artifacts, error codes); `.claude/skills/` only points at it. The contract itself lives in `guide/cli.md` and `app/src/main/java/dev/halcamera/cli/`.
